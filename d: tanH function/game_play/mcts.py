...
import time
import numpy as np
from global_settings import exp_gamma, exp_v_support, mcts_update_mode, mcts_rolling_alpha, rdn_beta, value_only, manual_over_ride_play_limit, temperature_changes, play_limit_mcts, c1, c2 , gamma, actions_size, play_limit_mcts, exponent_node_n, use_policy, dirichlet_alpha, ucb_denom_k, reward_support, value_support
    ...
    def expand(self,node):
        ...
        if node != self.root_node:
            ...
            if node.parent == self.root_node: #only using lead nodes for logging mean of RDN
                ...
                log = False
            rdn_value = rdn_beta * self.RDN_eval.evaluate(rdn_random,rdn_pred, log)
    ...
    def back_prop_rewards(self, node, v, exp_v):
        ...
        #Otherwise, we update the rolling average of novelty and intrinsic reward with values just received.
            ...
            if candidate_Q > node.total_Q:
                ...
                node.Qe += self.rolling_alpha*(exp_v - node.Qe)
