...
import sys
sys.path.append("..")
from global_settings import randomly_create_env, env_size, lakes, goals, star, deque_length
...
class gridWorld(Environment):
    ...
    def __init__(self, size,lakes,goals, n_actions = 4, max_steps = 300, dist = None, seed = None, rnd=0.1, lake_cov=[0.15, 0.25], randomly_create_env = True,star=star):
